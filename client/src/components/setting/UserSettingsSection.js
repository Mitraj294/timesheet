...
const UserSettingsSection = () => {
  ...
  const [infoFormData, setInfoFormData] = useState({
    name: '', email: '', country: '', phoneNumber: '', companyName: ''
  });
  ...
  return (
    <div className="user-settings-section-content">
      <Alert />
      {/* Account Information */}
        ...
        {!isEditingInfo ? (
          <>
            ...
            <div className="form-footer">
              <button className="btn btn-warning" onClick={handleInfoEditToggle} disabled={isLoading}>
                <FontAwesomeIcon icon={faEdit} /> Edit Account Info
              </button>
              <button className="btn btn-danger" onClick={handleRequestDeleteLink} disabled={isLoading || isRequestingDeleteLink}>
