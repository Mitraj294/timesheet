...
const projectSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchProjectById.pending, (state) => { state.currentProjectStatus = 'loading'; state.currentProjectError = null; state.currentProject = null; })
      .addCase(fetchProjectById.fulfilled, (state, action) => { state.currentProjectStatus = 'succeeded'; state.currentProject = action.payload; })
      .addCase(fetchProjectById.rejected, (state, action) => { state.currentProjectStatus = 'failed'; state.currentProjectError = action.payload; })
